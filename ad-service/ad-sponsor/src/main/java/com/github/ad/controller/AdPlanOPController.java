...
import com.github.ad.service.IAdPlanService;
...
public class AdPlanOPController {
    ...
    public AdPlanResponse createAdPlan(
            @RequestBody AdPlanRequest request) throws BusinessException {
    ...
    public List<AdPlan> getAdPlanByIds(
            @RequestBody AdPlanGetRequest request) throws BusinessException {
